(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{user:`CELIKIM`,message:`Llegó la primavera con su flor amarilla, que tu alegría siempre brille, bonita y sencilla. 💛🌼`},{user:`KIARIS`,message:`Primavera llegó vestida de amarillo, que nunca falte en tu día un momento bonito. 🌻💛`},{user:`MAFER`,message:`Florece la primavera con su luz y color, que las flores amarillas te llenen de amor. 💛🌻`},{user:`MARJORIE`,message:`Llegó la primavera cantando su canción, con flores amarillas y alegría en el corazón. 🌼💛`},{user:`ARIANA`,message:`Florece el sol con su brillo y alegría, que las flores amarillas iluminen tu día. 🌻✨`},{user:`DANITZA`,message:`Llegó la primavera con flores al pasar, que cada amarillo te haga sonreír y soñar. 💛🌼`},{user:`ROLIS`,message:`Llegaron las flores anunciando primavera, que tu sonrisa florezca feliz y duradera. 🌼😊`},{user:`ROX`,message:`Llegó la primavera con flores y esplendor, que el amarillo te regale alegría y mucho amor. 💛🌻`}],t=document.querySelector(`#app`),n=new Audio(`/assets/cancion.mpeg`);n.loop=!0,n.volume=.48;var r=[{src:`/assets/sunflower.gif`,alt:`Girasol floreciendo`},{src:`/assets/sunflower-pvz-dance.gif`,alt:`Girasol bailando`},{src:`/assets/sunflower-sunflower-plants-vs-zombies.gif`,alt:`Girasol sonriente`},{src:`/assets/sunflower-happy-dance.gif`,alt:`Girasol feliz`}];function i(e,t){return`
